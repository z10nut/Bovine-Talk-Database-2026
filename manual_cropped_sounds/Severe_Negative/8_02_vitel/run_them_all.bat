...
@REM python combine.py --LFC ".\%RUN_PARAM%\outLFC.txt" --HFC ".\%RUN_PARAM%\outHFC.txt" --out ".\%RUN_PARAM%\\"
...
@REM python compare.py -orig ".\%RUN_PARAM%\%RUN_PARAM%.xlsx" -new ".\%RUN_PARAM%\output.csv"